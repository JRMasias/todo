...
export default function Task() {
        return (
                <div className="flex flex-col md:flex-row justify-between items-center w-4/5 md:w-[500px] bg-neutral-800 px-4 py-3 rounded-md gap-2 max-w-4xl">
                        <p className="text-xl self-start md:self-center md:grow-0 md:border-r md:border-b md:p-2 md:border-neutral-900 rounded-2xl">
                                Some Task Desc HereSome Task Desc HereSome Task
                                Desc HereSome Task Desc HereSome Task Desc Here
                        </p>
